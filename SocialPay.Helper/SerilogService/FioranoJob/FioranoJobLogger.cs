...
namespace SocialPay.Helper.SerilogService.FioranoJob
{
    
    public class FioranoJobLogger
    {
        public IConfiguration Configuration { get; }
        public FioranoJobLogger(IConfiguration configuration)
        {
