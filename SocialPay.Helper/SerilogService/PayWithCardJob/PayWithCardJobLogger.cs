...
namespace SocialPay.Helper.SerilogService.PayWithCardJob
{
   
    public class PayWithCardJobLogger
    {
        public IConfiguration Configuration { get; }
        public PayWithCardJobLogger(IConfiguration configuration)
        {
