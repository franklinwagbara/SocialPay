...
namespace SocialPay.Helper.SerilogService.FioranoT24
{
    public class FioranoT24Logger
    {

        public IConfiguration Configuration { get; }
        public FioranoT24Logger(IConfiguration configuration)
        {
