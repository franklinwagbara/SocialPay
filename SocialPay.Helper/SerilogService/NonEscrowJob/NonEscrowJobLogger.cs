...
namespace SocialPay.Helper.SerilogService.NonEscrowJob
{
    
    public class NonEscrowJobLogger
    {
        public IConfiguration Configuration { get; }
        public NonEscrowJobLogger(IConfiguration configuration)
        {
