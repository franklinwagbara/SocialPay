...
namespace SocialPay.Helper.SerilogService.InterBankJob
{
    
    public class InterBankJobLogger
    {
        public IConfiguration Configuration { get; }
        public InterBankJobLogger(IConfiguration configuration)
        {
