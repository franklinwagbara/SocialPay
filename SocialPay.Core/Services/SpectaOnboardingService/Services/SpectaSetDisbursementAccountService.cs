            ...
            try
            {
                using (var transaction = await _context.Database.BeginTransactionAsync())
                {
                    try
                    {
                        ...
                        if (checkregistered.RegistrationStatus != AppResponseCodes.ConfirmTicket && checkregistered.RegistrationStatus != SpectaProcessCodes.CreateIndividualCurrentAccount)
