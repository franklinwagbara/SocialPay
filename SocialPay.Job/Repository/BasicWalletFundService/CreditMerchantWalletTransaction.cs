...
{
    public class CreditMerchantWalletTransaction : ICreditMerchantWalletService
    {
        private readonly CreditMerchantWalletService _transactions;
        public CreditMerchantWalletTransaction(IServiceProvider services, CreditMerchantWalletService transactions)
        {
            Services = services;
            ...
            try
            {
                ...
                using (var scope = Services.CreateScope())
                {
                    ...
                    var pendingTransactions = await context.TransactionLog
                        .Where(x => x.OrderStatus == OrderStatusCode.Pending).ToListAsync();
