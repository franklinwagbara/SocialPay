...
namespace SocialPay.Job.Repository.InterBankService
{
    ...
    {
        private readonly InterBankPendingTransferService _transactions;
        public InterBankTransferService(IServiceProvider services, InterBankPendingTransferService transactions)
        {
            Services = services;
            ...
            try
            {
                ...
                using (var scope = Services.CreateScope())
                {
                    ...
                    var pendingTransactions = await context.TransactionLog
                        .Where(x => x.AcitivityStatus == TransactionJourneyStatusCodes.CompletedWalletFunding).ToListAsync();
