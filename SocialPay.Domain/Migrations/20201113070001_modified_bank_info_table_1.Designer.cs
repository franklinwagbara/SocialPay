...
namespace SocialPay.Domain.Migrations
{
    ...
    [Migration("20201113070001_modified_bank_info_table_1")]
    partial class modified_bank_info_table_1
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SocialPay.Domain.Entities.ItemDispute", b =>
                {
                    b.Property<long>("ItemDisputeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                        .UseIdentityColumn();
                    ...
                    b.HasKey("ItemDisputeId");

                    b.HasIndex("ItemAcceptedOrRejectedId");

                    b.ToTable("ItemDispute");
                });
            ...
            modelBuilder.Entity("SocialPay.Domain.Entities.WalletTransferResponse", b =>
                {
                    ...
                    b.HasIndex("WalletTransferRequestLogId");
            ...
            modelBuilder.Entity("SocialPay.Domain.Entities.ItemDispute", b =>
                {
                    b.HasOne("SocialPay.Domain.Entities.ItemAcceptedOrRejected", "ItemAcceptedOrRejected")
                        .WithMany("ItemDispute")
                        .HasForeignKey("ItemAcceptedOrRejectedId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("SocialPay.Domain.Entities.WalletTransferResponse", b =>
                {
                    b.HasOne("SocialPay.Domain.Entities.WalletTransferRequestLog", "WalletTransferRequestLog")
                        .WithMany("WalletTransferResponse")
                        .HasForeignKey("WalletTransferRequestLogId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
