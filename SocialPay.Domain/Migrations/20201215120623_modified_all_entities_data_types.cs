...
{
    public partial class modified_all_entities_data_types : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FullName = table.Column<string>(type: "NVARCHAR(45)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Message = table.Column<string>(type: "NVARCHAR(350)", nullable: true),
                    DateEntered = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ResponseText = table.Column<string>(type: "NVARCHAR(90)", nullable: true),
                    ...
                    JsonResponse = table.Column<string>(type: "NVARCHAR(250)", nullable: true),
                    TransactionDate = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TransactionReference = table.Column<string>(type: "NVARCHAR(90)", nullable: true),
                    PaymentReference = table.Column<string>(type: "NVARCHAR(90)", nullable: true),
                    Message = table.Column<string>(type: "NVARCHAR(150)", nullable: true),
                    TransactionDate = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PaymentReference = table.Column<string>(type: "NVARCHAR(90)", nullable: false),
                    TransactionReference = table.Column<string>(type: "NVARCHAR(90)", nullable: true),
                    TransactionBranch = table.Column<string>(type: "NVARCHAR(90)", nullable: true),
                    TransactionType = table.Column<string>(type: "NVARCHAR(20)", nullable: true),
                    DebitAcctNo = table.Column<string>(type: "NVARCHAR(30)", nullable: true),
                    DebitCurrency = table.Column<string>(type: "NVARCHAR(10)", nullable: true),
                    CreditCurrency = table.Column<string>(type: "NVARCHAR(10)", nullable: true),
                    DebitAmount = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    CreditAccountNo = table.Column<string>(type: "NVARCHAR(20)", nullable: true),
                    CommissionCode = table.Column<string>(type: "NVARCHAR(15)", nullable: true),
                    VtellerAppID = table.Column<string>(type: "NVARCHAR(10)", nullable: true),
                    narrations = table.Column<string>(type: "NVARCHAR(110)", nullable: true),
                    SessionId = table.Column<string>(type: "NVARCHAR(40)", nullable: true),
                    TrxnLocation = table.Column<string>(type: "NVARCHAR(20)", nullable: true),
                    JsonRequest = table.Column<string>(type: "NVARCHAR(150)", nullable: true),
                    Channel = table.Column<string>(type: "NVARCHAR(10)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    MerchantBankInfoId = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ClientAuthenticationId = table.Column<long>(type: "bigint", nullable: false),
                    BankName = table.Column<string>(type: "NVARCHAR(30)", nullable: true),
                    ...
                    AccountName = table.Column<string>(type: "NVARCHAR(35)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BusinessEmail = table.Column<string>(type: "NVARCHAR(20)", nullable: true),
                    Country = table.Column<string>(type: "NVARCHAR(25)", nullable: true),
                    Tin = table.Column<string>(type: "NVARCHAR(20)", nullable: true),
                    Chargebackemail = table.Column<string>(type: "NVARCHAR(20)", nullable: true),
                    Logo = table.Column<string>(type: "NVARCHAR(20)", nullable: true),
                    FileLocation = table.Column<string>(type: "NVARCHAR(90)", nullable: true),
                    DateEntered = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
